    ...
    def resolver_colisiones(self, colisiones: List[Tuple[int, int]]):
        ...
        for id1, id2 in colisiones:
            ...
            if casilla_evasion:
                ...
                print(f"Montacargas {montacargas_menor_prioridad.id} se moverá a la casilla {casilla_evasion} para evadir")
                ...
                if exito:
                    ...
                    print(f"⚠️ Montacargas {montacargas_menor_prioridad.id} no pudo recalcular ruta desde la casilla de evasión")
                    montacargas_menor_prioridad.esperando = True
            else:
                # Si no hay casillas disponibles, hacer que espere
                print(f"⚠️ No hay casillas adyacentes disponibles para evasión. Montacargas {montacargas_menor_prioridad.id} esperará un turno")
                montacargas_menor_prioridad.esperando = True
        ...
        for id_montacargas, montacargas in self.montacargas.items():
            if montacargas.en_movimiento and not montacargas.esperando:
                ...
                if not sigue_moviendo:
                    print(f"✅ Montacargas {id_montacargas} ha llegado a su destino: producto {montacargas.destino_producto}")
    ...
    while True:
        ...
        if opcion == "1":
                    ...
                    try:
                        ...
                        posicion_input = input("Ingrese posición inicial (fila,columna) o presione Enter para la zona de carga: ")
                        ...
                        print(f"✅ Montacargas {id_montacargas} agregado en posición {montacargas.posicion} con prioridad {prioridad}")
